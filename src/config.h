...
/*  
    VEXT          > OLED VCC
    GPIO13 PIN45  > RGB LED (SK6812)
    GPIO14        > VGPS
*/

#define DEFAULT_PROFILE 4              // Profile to use after Reboot

#define MAX_PROFILE 4                  // Last PXX_ profile number
String const MAIN_CALLSIGN = "N0CALL"; // Your Callsign

// Profile 0 - Bike Symbol
#define BEACON_SYMBOL  "b"
#define BEACON_OVERLAY "/"
#define BEACON_MESSAGE "Cubecell LoRa Bike"
#define SB_ACTIVE      true                 // smart Beacon
#define BEACON_TIMEOUT 60                   // fixed Beacon interval in s if Smartbeacon inactive
#define CALLSIGN       MAIN_CALLSIGN + "-4" // your callsign

// Profile 1 - Runner Symbol
#define P1_BEACON_SYMBOL  "["
#define P1_BEACON_OVERLAY "/"
#define P1_BEACON_MESSAGE "Cubecell LoRa Walk"
#define P1_SB_ACTIVE      true                 // smart Beacon
#define P1_BEACON_TIMEOUT 60                   // fixed Beacon interval in s if Smartbeacon inactive
#define P1_CALLSIGN       MAIN_CALLSIGN + "-9" // your callsign
// Profile 2 - Balloon
...
//#ifndef Lora_RGB
#define LORA_RGB false  // activate Neopixel RGB LED
#define LORA_LED true   // activate halfAA pin13 led
#define LEDPIN GPIO13   //GPIO13 and not 13
